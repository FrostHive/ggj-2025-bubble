/***********************************************************
 * PaperMarioCameraController.cs
 * 
 * Attach this script to your main Camera. 
 * Provides three distinct "Paper Mario–style" camera views:
 *  1) Isometric
 *  2) 2D Platformer side view
 *  3) Front/Presentation view
 *
 * Usage:
 *  - Press keys 1, 2, or 3 to toggle among the three views.
 *  - Assign the player (or target) Transform in the Inspector.
 *  - Tweak each camera offset/angle in the Inspector as needed.
 ***********************************************************/
